...
import { AppLockGate } from '@/features/settings/components/AppLockGate.component';
...
import { useFontBootstrap } from '@/shared/hooks/useFontBootstrap.hook';
import { useAuthBootstrap } from '@/shared/hooks/useAuthBootstrap.hook';
import { useAuthNavigation } from '@/shared/hooks/useAuthNavigation.hook';
