...
import { CustomTabBar, type CustomTabBarProps } from '@/features/navigation/components/CustomTabBar.component';
...
export default function TabLayout() {
  ...
  return (
    ...
    >
      ...
      <Tabs.Screen name="ai" options={{ title: 'AI Coach', headerShown: false }} />
