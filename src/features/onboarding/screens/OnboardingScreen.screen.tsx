...
import { useOnboardingScreen } from '@/features/onboarding/hooks/useOnboardingForm.hook';

export function OnboardingScreen() {
  const { form, selectedCurrency, loading, submit, submitError, handleLogout } = useOnboardingScreen();
  const {
    control,
    handleSubmit,
    formState: { errors },
